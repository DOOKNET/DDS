...
#--------------------���ڶ�Ӧ������------------------------
#set_location_assignment PIN_B22 -to TXD
 set_location_assignment PIN_C20 -to RXD
...
#---------------------J7����˫·DA1-------------------------
 ...
 set_location_assignment PIN_W10	-to sin_50[8]
 set_location_assignment PIN_Y10	-to sin_50[7]
 set_location_assignment PIN_AA10	-to sin_50[6]
 set_location_assignment PIN_AB10	-to sin_50[5]
 set_location_assignment PIN_T9		-to sin_50[4]
 set_location_assignment PIN_U9		-to sin_50[3]
 set_location_assignment PIN_V9		-to sin_50[2]
 set_location_assignment PIN_AA9	-to sin_50[1]
 set_location_assignment PIN_AB9	-to sin_50[0]
 set_location_assignment PIN_T8		-to write_3
 set_location_assignment PIN_U8		-to da_clk3
 set_location_assignment PIN_V8		-to da_clk4

#---------------------J7����˫·DA2-------------------------
 set_location_assignment PIN_W8	    -to write_4
 set_location_assignment PIN_Y8	    -to sin_70[13]
 set_location_assignment PIN_AA8	-to sin_70[12]
 set_location_assignment PIN_AB8	-to sin_70[11]
 set_location_assignment PIN_U7		-to sin_70[10]
 set_location_assignment PIN_V7		-to sin_70[9]
 set_location_assignment PIN_W7		-to sin_70[8]
 set_location_assignment PIN_Y7	    -to sin_70[7]
 set_location_assignment PIN_AA7	-to sin_70[6]
 set_location_assignment PIN_AB7	-to sin_70[5]
 set_location_assignment PIN_V6		-to sin_70[4]
 set_location_assignment PIN_W6		-to sin_70[3]
 set_location_assignment PIN_Y6		-to sin_70[2]
 set_location_assignment PIN_V5		-to sin_70[1]
 set_location_assignment PIN_AA5    -to sin_70[0]
